  ...
  return (
    <>
      <section className="bg-card hidden h-72 flex-col rounded-md border p-4 md:flex">
        <div>
          <p className="text-muted-foreground text-[10px] font-semibold uppercase">Resumen del lote</p>
          <p className="text-muted-foreground mt-1 text-xs">Cambios preparados antes de confirmar.</p>
        </div>

        <div className="my-auto flex flex-col gap-3">
          <div>
            <p className="text-muted-foreground text-[10px] font-semibold uppercase">Unidades a ingresar</p>
          ...
          <div className="border-border/70 grid grid-cols-2 gap-3 border-t pt-3">
            <div>
              <p className="text-muted-foreground text-[10px] font-semibold uppercase">Nuevos</p>
              <p className="text-foreground/75 mt-1 text-sm font-semibold tabular-nums">{newItemsCount}</p>
            </div>
            <div>
              <p className="text-muted-foreground text-[10px] font-semibold uppercase">Reposición</p>
      ...
      <section className="bg-card rounded-md border p-3 md:hidden">
        ...
        <div className="border-border/70 mt-3 grid grid-cols-2 gap-3 border-t pt-3">
          <div className="min-w-0">
            <p className="text-muted-foreground text-[10px] font-semibold uppercase">Nuevos</p>
            <p className="text-xs font-semibold tabular-nums">{newItemsCount}</p>
          </div>
          <div className="min-w-0">
            <p className="text-muted-foreground text-[10px] font-semibold uppercase">Reposición</p>
            <p className="text-xs font-medium tabular-nums">{restockItemsCount}</p>
          </div>
        </div>
      </section>
    </>
