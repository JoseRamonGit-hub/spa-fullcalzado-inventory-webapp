...
export const pendingSaleColumns: ColumnDef<PendingSale>[] = [
  ...
  },
  {
    ...
    cell: ({ getValue }) => <span className="block text-right tabular-nums">{getValue<number>()}</span>,
  },
  {
  ...
  },
  {
    ...
    header: "",
    cell: ({ row, table }) => {
      const meta = table.options.meta as { onRemovePendingSale?: (id: string) => void } | undefined;
      return (
        <Button
          type="button"
          variant="ghost"
