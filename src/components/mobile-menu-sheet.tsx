      ...
      <DrawerContent className="w-[85vw] sm:max-w-sm h-full rounded-none border-l flex flex-col after:hidden">
        <DrawerHeader className="p-4  border-b text-left">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] uppercase tracking-wider px-2 py-0.5 rounded-full bg-primary/10 text-primary font-semibold shrink-0">
              {user?.role || "—"}
            </span>
          </div>
        </DrawerHeader>
                  ...
                  <Link
                    ...
                    className={`flex items-center gap-3 px-3 py-2.5 rounded-md transition-colors ${
                      isActive
                        ...
                        : "text-foreground hover:bg-accent/50 hover:text-foreground font-medium"
                    }`}
                  >
          ...
          <div className="px-4 pt-4 pb-2 mt-2 border-t">
            ...
            <div className="flex flex-col gap-1">
              <button
                ...
                className="flex w-full items-center gap-3 px-3 py-2.5 rounded-md transition-colors text-foreground hover:bg-accent/50 font-medium text-left"
              >
