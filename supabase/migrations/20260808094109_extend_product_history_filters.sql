drop function public.get_product_history(uuid, uuid, date, date);
...
revoke all on function public.get_product_history(uuid, uuid, date, date, boolean) from public, anon;
grant execute on function public.get_product_history(uuid, uuid, date, date, boolean) to authenticated, service_role;
